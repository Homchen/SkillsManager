...
/** 一键整理 */
export function IconFolderSync(props: IconProps) {
  return (
    <Icon {...props}>
...
/** 按工具批量启用 / 禁用 */
export function IconBulkToolLinks(props: IconProps) {
  return (
    <Icon {...props}>
...
/** 创建语言版本（从当前版本派生） */
export function IconCopyPlus(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M15 12v6" />
      <path d="M12 15h6" />
